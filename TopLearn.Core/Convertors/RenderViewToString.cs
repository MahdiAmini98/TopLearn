...
{
    //تبدیل ویو به استرینگ در ایمیل (کد فعال سازی که به ایمیل ارسال می شود):کار این کلاس این است که ویو مورد نظر ما را برای نمایش دادن در ایمیل تبدیل به    string کند
